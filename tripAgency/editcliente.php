        ...
        <form method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nome" value="<?= $row['nome'] ?>" placeholder="Inserisci il nome" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="cognome">Cognome:</label>
                    <input type="text" name="cognome" value="<?= $row['cognome'] ?>" placeholder="Inserisci il cognome" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="email">Email:</label>
                    <input type="email" name="email" value="<?= $row['email'] ?>" placeholder="Inserisci l'email" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="telefono">Telefono:</label>
                    <input type="text" name="telefono" value="<?= $row['telefono'] ?>" placeholder="Inserisci il telefono" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="nazione">Nazione:</label>
                    <input type="text" name="nazione" value="<?= $row['nazione'] ?>" placeholder="Inserisci la nazione" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="codice_fiscale">Codice Fiscale:</label>
                    <input type="text" name="codice_fiscale" value="<?= $row['codice_fiscale'] ?>" placeholder="Inserisci il codice fiscale" required>
                </div>

                <div class="col-md-6">
                    <label class="fw-bold" for="documento">Documento:</label>
                    <input type="text" name="documento" value="<?= $row['documento'] ?>" placeholder="Inserisci il documento" required>
                </div>
